...
export const paragraphStyle = "my-4 leading-relaxed text-base text-neutral-300"
export const unorderedListStyle =
  "list-disc [&_ul]:list-[revert] marker:text-xl marker:text-accent pl-5 [&>li]:my-4 [&>li]:leading-relaxed text-base text-neutral-300"
export const orderedListStyle =
  "list-decimal [&_ul]:list-[revert] marker:text-base marker:text-accent pl-5 [&>li]:my-4 [&>li]:leading-relaxed text-base text-neutral-300"
